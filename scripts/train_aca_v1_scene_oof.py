...
def scene_fold(scene):
    """
    Stratified by room:
    each fold gets exactly five scenes
    from each of four room types.
    """
...
print("=" * 104)
print("ACA-v1 4-FOLD SCENE-GROUPED OOF")
print("=" * 104)
...
for fold in range(4):
    ...
    print(
        ...
        f"AUC={auc:.3f}  "
        f"RestoreRate={100*pred.mean():6.2f}%"
    )
...
print("=" * 104)
print("PRIMARY OOF NAVIGATION RESULT")
print("=" * 104)
